<?php
        ...
        */
        ...
        $license_code = "D8FE9CFF-F16C-4FA8-9338-6101698526C9";
        $username =  "sushil74432";
	...
	*/
        ...
        if($httpCode != 200) 
	{
	   // OCR error
        ...
        // Task description
	echo 'TaskDescription:'.$data->TaskDescription."</br>";

        // Available pages 
	echo 'AvailablePages:'.$data->AvailablePages."</br>";

        // Extracted text
    echo 'OCRText='.$data->OCRText[0][0]."</br>";
    ...
    //echo 'OCRText[1][0]='.$data->OCRText[1][0]."</br>";
    //echo 'OCRText[1][1]='.$data->OCRText[1][1]."</br>";


    // Download output file (if outputformat was specified)

    $url = $data->OutputFileUrl;
    echo "Output URL: ".$url."</br>";
